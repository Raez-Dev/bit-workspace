...
This environment can be applied to all your components or a set of components via the command `bit env set <pattern or component_id> my-org.tasks-scope/envs/my-react`, or under the variants of your `workspace.json` file.
...
Run the command `bit env set <"pattern" or component_id> my-org.tasks-scope/envs/my-react` where the pattern is a glob pattern to select multiple components. This will put the env
...
```json
{
  "teambit.workspace/variants": {
    "{ui/**}, {pages/**}": {
      "my-org.tasks-scope/envs/my-react": {}
    }
  }
}
```
